...
public class SaishibaomingController {
    ...
    public R page(@RequestParam Map<String, Object> params,SaishibaomingEntity saishibaoming,
		...
		if(tableName.equals("cansaizhandui")) {
			saishibaoming.setCansaizhanghao((String)request.getSession().getAttribute("username"));
		}
	...
	public R remindCount(@PathVariable("columnName") String columnName, HttpServletRequest request, 
		...
		String tableName = request.getSession().getAttribute("tableName").toString();
		if(tableName.equals("cansaizhandui")) {
			wrapper.eq("cansaizhanghao", (String)request.getSession().getAttribute("username"));
		}
